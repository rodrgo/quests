# 014: *Cyclopsology* by [@cyclops-ui](https://github.com/cyclops-ui/)

| Prize pool | Start date | End date | Team size | Voting structure | Discord |
|  --- | --- | --- | --- | --- | --- |
| $1,000 USD | July 16, 2024  |  July 30, 2024 | 1 | 80/20 | [`#quest-015`](https://discord.gg/quira) |

## ✨ New in this Quest

1. We’ll be awarding a special `Helm` & `Kubernetes Operator` badges to developers that successfully complete the Quest.
2. Every valid submission will get swag 🧢
...
The goal of this track is to create some cool content about Cyclops. We suggest one of three types of content: 
...
- **Record a video for YouTube**: How about a video showing the world how you use Cyclops with your apps or projects? Or showing how much easier Cyclops is compared to plain Docker/Kubernetes? Or perhaps the recording of a livestream that shows everyone how you crack this quest? The sky is the limit! Brainstorm content types in our Discord server!
...
- Imagine you are the lead platform engineer or a DevOps lead at your company, and you need to develop your internal developer platform for Kubernetes with Cyclops
    ...
    - create your own use case and write a blog about it.

---

### 💙 Share the Cyclops love

Cyclops is debuting on ProductHunt! Help them make headlines by

- Starring their repo

  <img src="https://img.shields.io/github/stars/madushadhanushka?label=Stars" alt="stars">

- Subscribing & supporting to their ProductHung launch

  <a href="https://www.producthunt.com/products/cyclops?utm_source=badge-follow&utm_medium=badge&utm_souce=badge-cyclops" target="_blank"><img src="https://api.producthunt.com/widgets/embed-image/v1/follow.svg?product_id=566069&theme=light" alt="Cyclops - Developer&#0032;Friendly&#0032;Kubernetes | Product Hunt" style="width: 250px; height: 54px;" width="250" height="54" /></a>

### 💿 Quest's soundtrack

- https://www.youtube.com/watch?v=jRZL1ZA7wZE&list=PLu6_FOgZp3ejlGUW8JiACaf4vRgDtEhCw&index=33
